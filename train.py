...
def train(nloader, aloader, model, batch_size, optimizer, viz, device):
    with torch.set_grad_enabled(True):
        ...
        # score_abnormal异常分数, score_normal正常分数,
        # feat_select_abn异常特征, feat_select_normal,
        # feat_abn_bottom, feat_normal_bottom,
        # scores
        # scores_nor_bottom, scores_nor_abn_bag
        ...
        # 本文将每个片段获得的异常得分记作 f(v)，其中带有下标a的得分 f(v_a)  表示异常片段的得分
        # ，带有下标n的得分 f(v_n)  表示正常片段的得分；
